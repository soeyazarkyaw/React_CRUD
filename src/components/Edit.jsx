    ...
    <form  onSubmit={submitHandler} className='border-2 w-96 mx-auto mt-10 p-5 rounded-sm shadow-lg'>
      ...
      <div className='my-5'>
        ...
        <div className="relative mb-6">
          ...
          <input defaultValue={phone} onChange={e => setPhone(e.target.value)} type="number" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="09xxxxxxxxx"/>
        </div>
      </div>
      <div className='my-5 flex justify-center'>
        <button type='submit' className='px-4 py-2 bg-green-800 rounded uppercase text-white me-5'>Update</button>
